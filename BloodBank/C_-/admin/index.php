...
if(isset($_POST['loginBtn'])){
    ...
    if($username == "pankaj"){
        if($password == "admin"){
            ...
            header("Location: http://localhost/blood/admin/home.php");
        } else {
            ...
            <div class="panel-body">
                <form class="form-vertical" role="form" method="post" action="index.php">
                    ...
                    <div class="form-group loginBtn">
                        <button type="submit" name="loginBtn" class="btn btn-primary btn-sm btn-block">Login</button>
                    </div>
                </form>
      
             <a href="../users/index.php"name="back" class="btn btn-primary btn-sm">Back</a>
            </div>
        </div>
    </div>
    <div class="col-md-4"></div>
